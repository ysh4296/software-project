...
REQ-17 | 판매자는 주문정보(주소, 메뉴)를 확인할 수 있다. | 1
...
REQ-22 | 사이트관리자는 비 정상적인 사이트 이용자에 대해 제재(아이디 정지)를 가할 수 있다. | 2
REQ-23 | 사이트관리자는 비 정상적인 리뷰의 삭제요청을 승인 및 거부할 수 있다. | 2
REQ-24 | 사이트관리자는 광고 등록 요청을 승인할 수 있다. | 4
